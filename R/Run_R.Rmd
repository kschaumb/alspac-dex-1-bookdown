...
6. Creates maladaptive exercise models (saved in models/) and specifies model output for use in tables
7. Creates exercise for weight loss models (saved in models/) and specifies model output for use in tables
...
source('R/08-02-dex-models-output.R')
source('R/09-01-ewl-models.R')
source('R/09-02-ewl-models-output.R')
source('R/09-03-ewl-models-comparisons.R')
