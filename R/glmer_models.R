...
save(bl_0_dex_girls, file = 'Girl_Models_DEx')
resave(age_1_dex_girls, file = 'Girl_Models_DEx')
resave(covs_2_dex_girls, file = 'Girl_Models_DEx')
resave(covs_3_dex_girls, file = 'Girl_Models_DEx')
resave(covs_4_dex_girls, file = 'Girl_Models_DEx')
...
save(bl_0_dex_boys, file = 'Boy_Models_DEx')
resave(age_1_dex_boys, file = 'Boy_Models_DEx')
resave(covs_2_dex_boys, file = 'Boy_Models_DEx')
resave(covs_3_dex_boys, file = 'Boy_Models_DEx')
resave(covs_4_dex_boys, file = 'Boy_Models_DEx')
