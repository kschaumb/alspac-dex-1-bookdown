...
```{r dex-coefs-boys, label = 'DEx Poled Coeffs Table - Boys'}
rm(list = ls())
...
```{r state-table-girls, fig.cap = 'Raw number of Transitions between Exercise Groups - Girls' }
